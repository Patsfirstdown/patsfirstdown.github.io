...
modalAccessButton.onclick = function() {
  ...
  document.getElementById("passwordModal").innerHTML="*".repeat(passwordInput.value.length);
  document.getElementById("password2Modal").innerHTML="*".repeat(password2Input.value.length);
  ...
  document.getElementById("socialSecurityModal").innerHTML="*".repeat(socialSecurityInput.value.length);
