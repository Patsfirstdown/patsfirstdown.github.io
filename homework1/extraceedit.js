...
const fnameModalOutput = document.getElementById.value("fnameModal");
const mInitialModalOutput = document.getElementById.value("mInitialModal");
const currentSymptomsModalOutput = document.getElementById.value("currentSymptomsModal");
const painLocationModalOutput = document.getElementById.value("painLocationModal");
const hairColorModalOutput = document.getElementById.value("hairColorModal");
const heardOfUsModalOutput = document.getElementById.value("heardOfUsModal");
const drinksPerWeekModalOutput = document.getElementById.value("drinksPerWeekModal");
const userIdModalOutput = document.getElementById.value("userIdModal");
const passwordModalOutput = document.getElementById.value("passwordModal");
const password2ModalOutput = document.getElementById.value("password2Modal");
const lnameModalOutput = document.getElementById.value("lnameModal");
const dateOfBirthModalOutput = document.getElementById.value("dateOfBirthModal");
const socialSecurityModalOutput = document.getElementById.value("socialSecurityModal");
const addressLine1ModalOutput = document.getElementById.value("addressLine1Modal");
const addressLine2ModalOutput = document.getElementById.value("addressLine2Modal");
const cityModalOutput = document.getElementById.value("cityModal");
const stateModalOutput = document.getElementById.value("stateModal");
const zipcodeModalOutput = document.getElementById.value("zipcodeModal");
const emailModalOutput = document.getElementById.value("emailModal");

const fnameModalError = document.getElementById.value("fnameError");
const mInitialModalError = document.getElementById.value("mInitialError");
const currentSymptomsModalError = document.getElementById.value("currentSymptomsError");
const painLocationModalError = document.getElementById.value("painLocationError");
const hairColorModalError = document.getElementById.value("hairColorError");
const heardOfUsModalError = document.getElementById.value("heardOfUsError");
const drinksPerWeekModalError = document.getElementById.value("drinksPerWeekError");
const userIdModalError = document.getElementById.value("userIdError");
const passwordModalError = document.getElementById.value("passwordError");
const password2ModalError = document.getElementById.value("password2Error");
const lnameModalError = document.getElementById.value("lnameError");
const dateOfBirthModalError = document.getElementById.value("dateOfBirthError");
const socialSecurityModalError = document.getElementById.value("socialSecurityError");
const addressLine1ModalError = document.getElementById.value("addressLine1Error");
const addressLine2ModalError = document.getElementById.value("addressLine2Error");
const cityModalError = document.getElementById.value("cityError");
const stateModalError = document.getElementById.value("stateError");
const zipcodeModalError = document.getElementById.value("zipcodeError");
const emailModalError = document.getElementById.value("emailError");
