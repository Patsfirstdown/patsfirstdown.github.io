...
modalAccessButton.onclick = function() {
  const fnameModalError = document.getElementById("fnameError").value;
  const mInitialModalError = document.getElementById("mInitialError").value;
  const currentSymptomsModalError = document.getElementById("currentSymptomsError").value;
  const painLocationModalError = document.getElementById("painLocationError").value;
  const hairColorModalError = document.getElementById("hairColorError").value;
  const heardOfUsModalError = document.getElementById("heardOfUsError").value;
  const drinksPerWeekModalError = document.getElementById("drinksPerWeekError").value;
  const userIdModalError = document.getElementById("userIdError").value;
  const passwordModalError = document.getElementById("password1Error").value;
  const password2ModalError = document.getElementById("password2Error").value;
  const lnameModalError = document.getElementById("lnameError").value;
  const dateOfBirthModalError = document.getElementById("dOBError").value;
  const socialSecurityModalError = document.getElementById("socialSecurityError").value;
  const addressLine1ModalError = document.getElementById("addressLine1Error").value;
  const addressLine2ModalError = document.getElementById("addressLine2Error").value;
  const cityModalError = document.getElementById("cityError").value;
  const stateModalError = document.getElementById("stateError").value;
  const zipcodeModalError = document.getElementById("zipcodeError").value;
  const emailModalError = document.getElementById("emailError").value;
  
  modalBox.style.display = "block";
  document.getElementById("fnameModal").innerHTML=fnameInput.innerHTML;
  document.getElementById("mInitialModal").innerHTML=mInitialInput.innerHTML;
  document.getElementById("currentSymptomsModal").innerHTML=currentSymptomsInput.innerHTML;
  document.getElementById("painLocationModal").innerHTML=painLocationInput.innerHTML;
  document.getElementById("hairColorModal").innerHTML=hairColorInput.innerHTML;
  document.getElementById("heardOfUsModal").innerHTML=heardOfUsInput.innerHTML;
  document.getElementById("drinksPerWeekModal").innerHTML=drinksPerWeekInput.innerHTML;
  document.getElementById("userIdModal").innerHTML=userIdInput.innerHTML;
  document.getElementById("passwordModal").innerHTML=passwordInput.innerHTML;
  document.getElementById("password2Modal").innerHTML=password2Input.innerHTML;
  document.getElementById("lnameModal").innerHTML=lnameInput.innerHTML;
  document.getElementById("dateOfBirthModal").innerHTML=dateOfBirthInput.innerHTML;
  document.getElementById("socialSecurityModal").innerHTML=socialSecurityInput.innerHTML;
  document.getElementById("addressLine1Modal").innerHTML=addressLine1Input.innerHTML;
  document.getElementById("addressLine2Modal").innerHTML=addressLine2Input.innerHTML;
  document.getElementById("cityModal").innerHTML=cityInput.innerHTML;
  document.getElementById("stateModal").innerHTML=stateInput.innerHTML;
  document.getElementById("zipcodeModal").innerHTML=zipcodeInput.innerHTML;
  document.getElementById("emailModal").innerHTML=emailInput.innerHTML;
