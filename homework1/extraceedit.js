...
modalAccessButton.onclick = function() {
  ...
  document.getElementById("currentSymptomsModal").innerHTML=currentSymptomsInput;
  document.getElementById("painLocationModal").innerHTML=painLocationInput;
  document.getElementById("hairColorModal").innerHTML=hairColorInput;
  document.getElementById("heardOfUsModal").innerHTML=heardOfUsInput;
  document.getElementById("drinksPerWeekModal").innerHTML=drinksPerWeekInput;
  document.getElementById("userIdModal").innerHTML=userIdInput;
  document.getElementById("passwordModal").innerHTML=passwordInput;
  document.getElementById("password2Modal").innerHTML=password2Input;
  document.getElementById("lnameModal").innerHTML=lnameInput;
  document.getElementById("dateOfBirthModal").innerHTML=dateOfBirthInput;
  document.getElementById("socialSecurityModal").innerHTML=socialSecurityInput;
  document.getElementById("addressLine1Modal").innerHTML=addressLine1Input;
  document.getElementById("addressLine2Modal").innerHTML=addressLine2Input;
  document.getElementById("cityModal").innerHTML=cityInput;
  document.getElementById("stateModal").innerHTML=stateInput;
  document.getElementById("zipcodeModal").innerHTML=zipcodeInput;
  document.getElementById("emailModal").innerHTML=emailInput;
